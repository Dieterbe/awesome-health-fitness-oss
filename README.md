...
|------------|----------------------------------------------------------------|------|----------------------------------------------------------------------|---------|
| Bloodboy | Privacy-first browser-based blood test tracker with local storage and visualization. Helps track longevity biomarkers. No account required. | React | [GH](https://github.com/mizoloff/bloodboy) | MIT |
...
| Workout time! | app for managing and performing conditioning workouts | Flutter | [GL](https://gitlab.com/enjoyingfoss/feeel), [f-droid](https://f-droid.org/packages/es.ideotec.workouttime/) | GPL v3 |
